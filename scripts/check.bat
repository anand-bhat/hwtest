python projectProgressChecker.py -f ../docs/assets/data/13827.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/13828.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/13829.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/13830.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/14377.json -st alternate
python projectProgressChecker.py -f ../docs/assets/data/14520.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/14521.json -st alternate x
python projectProgressChecker.py -f ../docs/assets/data/14525.json -st alternate x
...
python projectProgressChecker.py -f ../docs/assets/data/14903.json -st alternate x
